...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see cn.corlin.service.impl.PasswordTokenManager#generateRecoveryToken(cn.corlin.model.User)
     */
    @Override
    ...
    /**
     * @see cn.corlin.service.impl.PasswordTokenManager#isRecoveryTokenValid(cn.corlin.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see cn.corlin.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override

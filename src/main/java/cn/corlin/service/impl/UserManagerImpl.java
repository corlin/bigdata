...
import cn.corlin.dao.UserDao;
import cn.corlin.model.User;
import cn.corlin.service.MailEngine;
import cn.corlin.service.UserExistsException;
import cn.corlin.service.UserManager;
import cn.corlin.service.UserService;
 ...
 */
@Service("userManager")
@WebService(serviceName = "UserService", endpointInterface = "cn.corlin.service.UserService")
public class UserManagerImpl extends GenericManagerImpl<User, Long> implements UserManager, UserService {
     ...
     * @see cn.corlin.service.MailEngine#sendMessage(org.springframework.mail.SimpleMailMessage, String, java.util.Map)
     */
